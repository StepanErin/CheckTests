...
namespace CheckTests.Operators
{
    ...
    /// </summary>
    static public class SymmetricEncryption_Operator
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static byte[] ToAes256(string src, string codeForEncryption)
        {
            ...
            aes.Key = Encoding.ASCII.GetBytes(codeForEncryption);
            byte[] encrypted;
        ...
        public static string FromAes256(byte[] shifr, string codeForEncryption)
        {
